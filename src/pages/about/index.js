        ...
        <>
            ...
            <div className="bg-gray-100 p-5">
                <div className='bg-white shadow rounded  border p-5'>
                    ...
                    <p className='my-3 text-gray-500'>  Whether you are a seasoned tech expert or a newcomer to the world of mobile devices and gadgets, {APP_NAME}  is the ultimate destination for all your tech needs. We are committed to providing accurate, reliable, and engaging content that will keep you informed and entertained. Join our community today and stay ahead of the curve!
                    </p>
                </div>
            </div>
        </>
